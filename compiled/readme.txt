...
================================
-autoalignmatlab 
-run_autoalignmatlab.sh (shell script for temporarily setting environment variables and 
                         executing the application)
   -to run the shell script, type
   
       ./run_autoalignmatlab.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v92, run the shell script as:
       ...
       ./run_autoalignmatlab.sh /mathworks/home/application/v92
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_autoalignmatlab.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
(2) If the environment variable LD_LIBRARY_PATH is undefined, set it to the concatenation 
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_autoalignmatlab.sh 
